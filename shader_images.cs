...
public string ProcessArticle(string ArticleText, string ArticleTitle, int wikiNamespace, out string Summary, out bool Skip)
{
    ...
    //Remove old infobox
    int InfoboxStart = ArticleText.IndexOf("{{Infobox/Item");
    string oldTemplate = WikiFunctions.Parse.Parsers.GetTemplate(ArticleText, "Infobox/Item");
    ...
    if (image.Length == 0 && WikiFunctions.Parse.Parsers.GetTemplate(ArticleText, "Images") == "" && !ArticleText.Contains("Deleted Material"))
    {
        ...
        ArticleText = "{{Images|10 August 2016|itemtype=Shader}}" + temp + ArticleText;
